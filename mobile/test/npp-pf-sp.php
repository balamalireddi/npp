<!DOCTYPE html>
    ...
    <title>Digital Privacy Notice - Create NPP for Provider - Español</title>
    </head>
 ...
 <form id="mydpnForm" action="nppcreator.php" method="post">
          ...
          <div class="panel callout radius">
            <div id="1-Stop">
              <label id="label-InstaA"><b>Instruction A:</b>
                <input type="text" id="instA" name="instA" placeholder="Insert the covered entity's name" style="font-size:16px;font-weight:bold; height: 3.780rem !important;" tabindex="1" />
              </label>
              <small class="error" id="msg-InstaA" style="display:none">Insert the covered entity's name</small>
            </div>
          </div>  
      </div>
  ...
  <div class="row collapse panel radius">
    ...
    <div class="medium-6 large-8 columns">
        <p>Esta notificación describe cómo puede utilizarse y divulgarse su información médica, y cómo puede acceder usted a esta información. <b>Revísela con cuidado.</b></p>
    </div>
  </div>
  ...
  <section class="panel callout radius">
    ...
    <div class="row">
        <div class="medium-6 large-4 columns"><b>Obtener una copia en formato electrónico o en papel de su historial médico</b></div>
        <div class="medium-6 large-8 columns">
          <ul class="disc">
    ...
    <div class="row">
        <div class="medium-6 large-4 columns"><b>Solicitarnos que corrijamos su historial médico</b></div>
        <div class="medium-6 large-8 columns">
          <ul class="disc">
    ...
    <div class="row">
        <div class="medium-6 large-4 columns"><b>Solicitarnos que limitemos lo que utilizamos o compartimos</b></div>
        <div class="medium-6 large-8 columns">
          <ul class="disc">
    ...
    <div class="row">
        <div class="medium-6 large-4 columns"><b>Recibir una lista de aquellos con quienes hemos compartido información</b></div>
        <div class="medium-6 large-8 columns">
          <ul class="disc">
    ...
    <div class="row">
        <div class="medium-6 large-4 columns"><b>Obtener una copia de esta notificación de privacidad</b></div>
        <div class="medium-6 large-8 columns">
          <ul class="disc">
            <li>Puede solicitar una copia en papel de esta notificación en cualquier momento, incluso si acordó recibir la notificación de forma electrónica. Le proporcionaremos una copia en papel de inmediato.</li>
          </ul>  
        </div>
        <hr>
    </div>
    ...
    <div class="row">
        <div class="medium-6 large-4 columns"><b>Elegir a alguien para que actúe en su nombre</b></div>
        <div class="medium-6 large-8 columns">
          <ul class="disc">
     ...
     <div class="row">
        <div class="medium-6 large-4 columns"><b>Presentar una queja si considera que se violaron sus derechos</b></div>
        <div class="medium-6 large-8 columns">
          <ul class="disc">
    ...
    <div class="row">
      ...
      <div class="medium-6 large-8 columns">
        <ul class="disc">
          ...
          <li>Incluyamos su información en un directorio hospitalario.</li>
        </ul>
  ...
  <div class="row">
      <div class="medium-6 large-4 columns"><b>En el caso de recaudación de fondos:</b></div>
      <div class="medium-6 large-8 columns">
        <ul class="disc">
          <li> Podemos comunicarnos con usted por temas de recaudación, pero puede pedirnos que no lo volvamos a contactar.</li>
        </ul>  
      </div>
    </div>
  ...
  <section class="collapse panel callout radius">
    ...
    <div class="row">
      <div class="medium-2 large-2 columns"><b>Tratamiento</b></div>
      <div class="medium-5 large-5 columns">
        <ul class="disc">
          <li>Podemos utilizar su información médica y compartirla con otros profesionales que lo estén tratando.</li>
        </ul>  
      </div>
      <div class="medium-5 large-5 columns"><p><i><b>Ejemplo:</b> Un médico que lo está tratando por una lesión le consulta a otro doctor sobre su estado de salud general.</i></p></div>
      <hr>
    </div>
     ...
     <div class="row">
      ...
      <div class="medium-5 large-5 columns">
        <ul class="disc">
          <li>Podemos utilizar y divulgar su información para llevar a cabo nuestra práctica, mejorar su atención y comunicarnos con usted cuando sea necesario.</li>
        </ul>  
      </div>
      <div class="medium-5 large-5 columns"><p><i><b>Ejemplo:</b> Utilizamos información médica sobre usted para administrar su tratamiento y servicios.</i></p></div>
      <hr>
    </div>

     <div class="row">
      <div class="medium-2 large-2 columns"><b>Facturar por sus servicios</b></div>
      <div class="medium-5 large-5 columns">
        <ul class="disc">
          <li>Podemos utilizar y compartir su información para facturar y obtener el pago de los planes de salud y otras entidades.</li>
        </ul>  
      </div>
      <div class="medium-5 large-5 columns"><p><i><b>Ejemplo:</b> Entregamos información acerca de usted a su plan de seguro médico para que éste pague por sus servicios.</i></p></div>
      <hr>
    </div>
  ...
  <div class="row">
      <div class="medium-6 large-4 columns"><b>Responder a las solicitudes de donación de órganos y tejidos</b></div>
      <div class="medium-6 large-8 columns">
        <ul class="disc">
  ...
  <div class="row">
      <div class="medium-6 large-4 columns"><b>Trabajar con un médico forense o director funerario</b></div>
      <div class="medium-6 large-8 columns">
        <ul class="disc">
    ...
    <div class="row">
      <div class="medium-12 large-12 columns">  
        ...
        <p>Para mayor información, visite: <a href="http://www.hhs.gov/ocr/privacy/hipaa/understanding/consumers/factsheets_spanish.html"><b>www.hhs.gov/ocr/privacy/hipaa/understanding/consumers/factsheets_spanish.html</b></a>, disponible en español.</p>
            <p><b>Cambios a los términos de esta notificación</b><br> Podemos modificar los términos de esta notificación, y los cambios se aplicarán a toda la información que tenemos sobre usted. La nueva notificación estará disponible según se solicite, en nuestra oficina, y en nuestro sitio web.
        </p>
      </div>
    </div>
